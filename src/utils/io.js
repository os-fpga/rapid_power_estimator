...
export const slew_rate = [
    { id: 0, text: "Fast" },
    { id: 1, text: "Slow" },
];

export const differential_termination = [
    { id: 0, text: "Off" },
    { id: 1, text: "On" },
];

export const io_data_type = [
    { id: 0, text: "SDR" },
    { id: 1, text: "DDR" },
    { id: 2, text: "Clock" },
    { id: 3, text: "Async" },
